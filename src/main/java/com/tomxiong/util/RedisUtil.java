...
public class RedisUtil {
    ...
    public static String randomKey() {
        return redisTemplate.randomKey()+ StringUtils.EMPTY;
    }
    ...
    public static String get(String key) {
        return redisTemplate.opsForValue().get(key)+ StringUtils.EMPTY;
    }
    ...
    public static String getAndSet(String key, String value) {
        return redisTemplate.opsForValue().getAndSet(key, value)+ StringUtils.EMPTY;
    }
    ...
    public static String lIndex(String key, long index) {
        return redisTemplate.opsForList().index(key, index)+ StringUtils.EMPTY;
    }
    ...
    public String lLeftPop(String key) {
        return redisTemplate.opsForList().leftPop(key)+ StringUtils.EMPTY;
    }
    ...
    public String lBLeftPop(String key, long timeout, TimeUnit unit) {
        return redisTemplate.opsForList().leftPop(key, timeout, unit)+ StringUtils.EMPTY;
    }
    ...
    public String lRightPop(String key) {
        return redisTemplate.opsForList().rightPop(key)+ StringUtils.EMPTY;
    }
    ...
    public String lBRightPop(String key, long timeout, TimeUnit unit) {
        return redisTemplate.opsForList().rightPop(key, timeout, unit)+ StringUtils.EMPTY;
    }
    ...
    public String lRightPopAndLeftPush(String sourceKey, String destinationKey) {
        return redisTemplate.opsForList().rightPopAndLeftPush(sourceKey,
                destinationKey)+ StringUtils.EMPTY;
    }
    ...
    public String lBRightPopAndLeftPush(String sourceKey, String destinationKey,
        ...
        return redisTemplate.opsForList().rightPopAndLeftPush(sourceKey,
                destinationKey, timeout, unit)+ StringUtils.EMPTY;
    }
    ...
    public String sPop(String key) {
        return redisTemplate.opsForSet().pop(key)+ StringUtils.EMPTY;
    }
    ...
    public static String sRandomMember(String key) {
        return redisTemplate.opsForSet().randomMember(key)+ StringUtils.EMPTY;
    }
